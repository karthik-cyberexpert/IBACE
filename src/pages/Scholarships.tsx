...
const bgImage = "/images/scholarship.jpg"; // Placeholder path
...
export default function Scholarships() {
  ...
  return (
    <div className="sch-page">
      {/* BACKGROUND IMAGE */}
      <img src={bgImage} alt="bg" className="bg-img" onError={(e) => (e.target as HTMLImageElement).style.background = '#1e293b'} />
